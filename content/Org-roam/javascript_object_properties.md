...
- [Syntax](#syntax)
- [Invalid binding names](#invalid-binding-names)
- [Non existant property](#non-existant-property)

# Description

Values of the type \[JavaScript Objects]\(JavaScript Objects) are arbitrary collections of properties
