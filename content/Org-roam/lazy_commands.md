...
From \[Symfony 4.0]\(Symfony 4.0) commands are lazily loaded. One broken command won't break all the other commands you have. In order to lazy-load a command do the following:
