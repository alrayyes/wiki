...
As with [[Rust Structs Syntax]], methods can be defined as well:
...
Instead of `null` Rust has the [Option](https://doc.rust-lang.org/std/option/enum.Option.html) enum built in:
