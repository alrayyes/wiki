...
Sometimes you want to know whether an \[JavaScript Objects]\(JavaScript Objects) was derived from a specific \[JavaScript Class Notation]\(JavaScript Class Notation). To do this one can use the ~instanceof~ \[JavaScript Operators]\(JavaScript Operators).
