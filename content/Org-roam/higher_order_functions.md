...
- [Examples](#examples)
  - [Functions that create new functions](#functions-that-create-new-functions)
  - [Functions that change other functions](#functions-that-change-other-functions)
  - [Functions that provide new types of flow control](#functions-that-provide-new-types-of-flow-control)
  - [ES6](#es6)
    - [Funciton properties](#funciton-properties)
      - [name](#name)
