...
As soon as you have a string index signature, all explicit members must also conform to that index signature. A few [[TypeScript Interfaces]] examples:
...
[[TypeScript Literal Types]] can also be used in the declaration:
...
[[TypeScript Generics]] can also be used:
