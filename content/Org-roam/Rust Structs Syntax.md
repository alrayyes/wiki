...
modified: 2026-08-12T10:31:55.428Z
---
...
```
User 1
User email is: someone@example.com
User username is: someusername123
User sign in count is: 1
User active is: true
User 2
User email is: anotheremail@example.com
User username is: someusername123
User sign in count is: 1
User active is: true
```
...
To print out debugging information we have the [debug trait](https://doc.rust-lang.org/std/fmt/trait.Debug.html):
...
These are Rust's take on static functions. They _don't_ take ~self~ as a parameter
