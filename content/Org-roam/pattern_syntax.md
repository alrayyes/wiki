...
- [Examples](#examples)
  ...
  - [Destructuring](#destructuring)
    ...
    - [Destructuring and matching literal values in one pattern](#destructuring-and-matching-literal-values-in-one-pattern)
...
\[Rust enums]\(Rust enums) can also be deconstructed:
...
Nested \[Rust Structs Syntax]\(Rust Structs Syntax) and \[Rust enums]\(Rust enums) can also be destructured:
