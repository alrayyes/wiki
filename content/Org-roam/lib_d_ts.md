...
- [Example](#example)
  - [lib.d.ts magic](#libdts-magic)
  - [Example of what's in the lib.d.ts](#example-of-whats-in-the-libdts)

# Introduction

This is where TypeScript "cheats" and ships with a file called \[\[https://github.com/microsoft/TypeScript/blob/master/lib/lib.d.ts]\[lib.d.ts]]. This file contains ambient declarations for a whole bunch of common [JavaScript](JavaScript) constructs present in JavaScript runtimes and the DOM.
