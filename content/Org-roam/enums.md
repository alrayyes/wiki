...
- [Basics](#basics)
- [Methods](#methods)
- [Standard library enums](#standard-library-enums)
  - [Option](#option)
- [Match control flow operator](#match-control-flow-operator)
  ...
  - [if let syntax suger](#if-let-syntax-suger)

# Basics

Rust also supports \[\[https://doc.rust-lang.org/rust-by-example/custom\_types/enum.html]\[enums]].
...
As with \[Rust Structs Syntax]\(Rust Structs Syntax), methods can be defined as well:
...
Instead of `null` Rust has the \[\[https://doc.rust-lang.org/std/option/enum.Option.html]\[Option]] enum built in:
