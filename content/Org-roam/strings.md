...
- [Concatentation](#concatentation)
  - [Concatenate multiple strings](#concatenate-multiple-strings)
    - [With +](#with-)
...
Many \[Rust Vectors]\(Rust Vectors) are also available for Strings.
...
To generate a ~String~ with initial data we can use the \[\[https://doc.rust-lang.org/std/string/trait.ToString.html#tymethod.to\_string]\[to\_string]] method:
