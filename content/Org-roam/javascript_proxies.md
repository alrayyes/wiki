...
- [Examples](#examples)
- [Use cases for proxies](#use-cases-for-proxies)
  - [Tracing property acesses (get, set)](#tracing-property-acesses-get-set)
  - [Warning about unknown properties (get,set)](#warning-about-unknown-properties-getset)
    - [Unknown Property Examples](#unknown-property-examples)
      - [Object](#object)
      - [Class](#class)
  - [Negative Array indices (get)](#negative-array-indices-get)
  - [Data binding (set)](#data-binding-set)
  - [Accessing a restful web service](#accessing-a-restful-web-service)
  - [Recoverable references](#recoverable-references)
- [See also](#see-also)

# Introduction

ECMAScript 6 proxies bring intercession to [JavaScript](JavaScript). They work as follows. There are many operations that you can perform on an \[JavaScript Objects]\(JavaScript Objects) obj. For example:
...
If we turn ~PropertyChecker~ into a constructor, we can use it for \[JavaScript Class Notation]\(JavaScript Class Notation) via extends:
...
Some \[JavaScript Array Prototype Methods]\(JavaScript Array Prototype Methods) let you refer to the last element via -1, to the second-to-last element via -2, etc. For example:
