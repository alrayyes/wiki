...
Consider the following [[JavaScript function declarations]] using [[TypeScript Tuple Type]]:
...
The [[Spread (...)]] in [[TypeScript Tuple Type]] syntax to be [[TypeScript Generics]]:
...
[[JavaScript Rest Parameters]] elements can occur anywhere in a [[TypeScript Tuple Type]], not just at the end:
