...
Slices are like references. Change something in the slice and the [[Golang Arrays]] it references also changes
...
New elements can be added to a slice with the [append](https://golang.org/pkg/builtin/#append) function
