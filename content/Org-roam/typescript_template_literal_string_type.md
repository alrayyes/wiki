...
TypeScript supports template literal strings\[fn:pr], with the same syntax as \[JavaScript Template Literals]\(JavaScript Template Literals). There is also an in progress PR to switch to type alias helpers\[fn:aliashelpers].
...
With \[TypeScript Union Type]\(TypeScript Union Type) you can mix and match.
...
\[fn:aliashelpers]https://github.com/microsoft/TypeScript/pull/40580
\[fn:pr]https://github.com/microsoft/TypeScript/pull/40336
