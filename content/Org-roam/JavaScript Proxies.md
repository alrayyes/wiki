...
If we turn ~PropertyChecker~ into a constructor, we can use it for [[JavaScript Class Notation]] via extends:
...
Some [[JavaScript Array Prototype Methods]] let you refer to the last element via -1, to the second-to-last element via -2, etc. For example:
