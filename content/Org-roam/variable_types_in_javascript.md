...
- [ES6](#es6)
  - [Symbols](#symbols)
    ...
    - [Every Symbol is unique](#every-symbol-is-unique)
...
Backtick quoted strings (\[\[https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template\_literals]\[template literals]]) can span lines and also embed other values. \${} in a template literal will be computed and converted to a string
